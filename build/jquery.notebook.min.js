  ...
  var o, i = function() {
    ...
    r = {
      ...
      commands: {
        ...
        h1: function(n) {
          n.preventDefault(), e(window.getSelection().anchorNode.parentNode).is("h1") ? t.execCommand("formatBlock", !1, "<p>") : t.execCommand("formatBlock", !1, "<h1>"), d.update.call(this)
        },
        h2: function(n) {
          n.preventDefault(), e(window.getSelection().anchorNode.parentNode).is("h2") ? t.execCommand("formatBlock", !1, "<p>") : t.execCommand("formatBlock", !1, "<h2>"), d.update.call(this)
        },
        ul: function(e) {
